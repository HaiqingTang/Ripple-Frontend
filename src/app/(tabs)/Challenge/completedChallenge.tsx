    ...
    <View style={coupon.wrap}>
      <View style={[coupon.card, SHADOW]}>
        ...
        <View style={coupon.mid}>
          ...
          <View style={[coupon.hole, coupon.holeTop]} />
          <View style={[coupon.hole, coupon.holeBottom]} />
        </View>
...
const coupon = StyleSheet.create({
  ...
  hole: {
    ...
    width: HOLE + 2,
    height: HOLE + 2,
    borderRadius: (HOLE + 2) / 2,
    backgroundColor: BG,
    left: -3,
    zIndex: 3,
  },
  holeTop: { top: -(HOLE + 2) / 2 },
  holeBottom: { bottom: -(HOLE + 2) / 2 },
  right: { flex: 1, justifyContent: "center", paddingHorizontal: 14, gap: 6 },
  rule: { fontSize: 18, fontWeight: "800", color: COUPON_TEXT },
  validity: { fontSize: 13, fontWeight: "700", color: COUPON_TEXT, opacity: 0.9 },
});
