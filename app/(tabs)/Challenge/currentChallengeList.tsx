      ...
      <View key={`${isCompleted ? "done-" : "go-"}${c.id}`} style={styles.card}>
        ...
        <View style={styles.metaRow}>
          <View style={styles.metaItem}>
            ...
            <Text style={[styles.metaTextDark, styles.metaTextPad]}>{c.days} days</Text>
          </View>
          <View style={[styles.metaItem, styles.metaItemRight]}>
            <Ionicons name="people-outline" size={18} color="#000" />
            <Text style={[styles.metaTextDark, styles.metaTextPad]}>{c.joined} joined</Text>
          </View>
        </View>
        ...
        <View style={styles.bottomRow}>
          ...
          {isCompleted ? (
            <View style={{ flexDirection: "row" }}>
              <Pressable
                style={[styles.actionBtn, { backgroundColor: "#16A34A", marginRight: 10 }]}
      ...
      <View style={styles.container}>
        ...
        {!!listError && (
          <View style={styles.errorBar}>
            ...
            <Text style={[styles.errorText, styles.errorTextPad]} numberOfLines={2}>
              {listError}
            </Text>
            <Pressable onPress={() => setListError(null)} hitSlop={8} style={styles.errorDismissBtn}>
        ...
        {!!undoData && (
          <View style={styles.snackbar}>
            ...
            <Pressable onPress={undoDelete} hitSlop={8} style={{ marginLeft: 12 }}>
...
const styles = StyleSheet.create({
  ...
  errorTextPad: { marginLeft: 8 },
  errorDismissBtn: { marginLeft: 8 },
  ...
  // row with two meta items; use margin instead of gap for RN compatibility
  metaRow: {
    marginTop: 8,
    flexDirection: "row",
  ...
  metaItemRight: { marginLeft: 22 },
  metaTextDark: { color: "#000", fontWeight: "600" },
  metaTextPad: { marginLeft: 6 },
