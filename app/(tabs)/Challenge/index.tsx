...
// 路由映射（注意：不要写 (tabs) 分组名）
const ROUTE_BY_KEY: Record<string, string | undefined> = {
  nutrition: "/Challenge/nutritionChallengeList",
  // 后续需要时再逐个放开：
  // fitness: "/Challenge/fitnessChallengeList",
  // meditation: "/Challenge/meditationChallengeList",
  // tech: "/Challenge/techChallengeList",
  // art: "/Challenge/artChallengeList",
};
        ...
        <View style={styles.listHolder}>
          ...
          >
            {LIST.map((it) => {
              ...
              if (href) {
                return (
                  <Link key={it.key} href={href} asChild>
              ...
              // 未配置路由的卡片仍可渲染但不跳转（或这里你也可以给个 Toast/Alert）
              return (
