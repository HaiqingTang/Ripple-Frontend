  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "left", "right", "bottom"]}>
      ...
      >
        ...
        {/* Reward Card (actual) */}
        {rc && (rc.name || rc.vendor || rc.value || rc.description || rc.validUntil) && (
          <CouponCard
            amountText={rc.value || "¥5"}
            ruleText={rc.name || rc.vendor || "Available on orders over 500"}
            validityText={rc.validUntil ? formatValidUntil(rc.validUntil) : undefined}
          />
        )}
...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, textAlign: "center", fontSize: 24, fontWeight: "900", color: TEXT_BLUE},
