...
## Sprint 1 – [11/08 to 31/08]

**Goal:** Establish project foundations, document requirements, and create initial design concepts.  
### Added
- [Documentation] Initial project documentation  
- [Documentation] Project overview & requirements  
- [Documentation] Requirement analysis and user needs  
- [Documentation] Personas to guide design decisions  
- [Documentation] DO BE FEEL model for motivation and goals  
